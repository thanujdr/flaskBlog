...
def send_reset_email(user):
    ...
    msg = Message(subject='Password Reset Request', sender='thanuj.dr@gmail.com', recipients=[user.email])
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with instruction to reset the password')
        return redirect(url_for('login'))
...
def reset_token(token):
    ...
    if user is None:
        flash('This is an invalid token')
